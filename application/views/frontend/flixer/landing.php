...
<div style="height:93vh;width:100%;background-image: url(<?php echo base_url().'assets/frontend/flixer/images/home_top_banner.jpg';?>)">
	...
	<div  class="bp-register">
		<div class="bp-register-text">
			<?php echo get_phrase('See_what_is_next.');?>
		</div>
		<div class="bp-register-btn">
			<?php echo get_phrase('WATCH_ANYWHERE.');?> <?php echo get_phrase('CANCEL_ANYTIME.');?>
		</div>
		
		<div class="bp-email-box">
			<input type="text" name="email" placeholder="Email or phone"  />
			<a href="<?php echo base_url();?>index.php?home/plans" class="btn btn-danger btn-lg bp-btn-signup">
